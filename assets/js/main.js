...
!(function (e) {
      ...
      a = (function () {
        function e() {
          ...
          (this.themePath = t.dataset.path),
            ...
            this._init(),
            s.default.isTouch &&
              (window.addEventListener('touchstart', s.default.onTouchStart),
              window.addEventListener('touchmove', s.default.onMouseMove)),
            window.addEventListener('mousemove', s.default.onMouseMove),
            window.addEventListener('resize', this._onResize.bind(this)),
            'plink.local.com' === location.hostname && document.body.classList.add('show-grid'),
    ...
    function n(e, t, i, o, n) {
      ...
      return (
        ...
        n &&
          ...
          ((r.value = r.initializer ? r.initializer.call(n) : void 0), (r.initializer = void 0)),
        void 0 === r.initializer && (Object.defineProperty(e, t, r), (r = null)),
        r
      );
    }
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = void 0);
    var r,
      ...
      d =
          ...
          return (
            s(e, [
              ...
              },
              {
                ...
                value: function (t, i) {
                  var o;
                  (o = u.sitemap.pages[e.currentId]
                    ? u.sitemap.pages[e.currentId].class
                    : u.sitemap.pages.default.class),
                    i || (this._previousPage = this._page);
                  var n = new o.default(t, this._page);
                  n.init(),
                    n.shown.add(this._onPageShown),
                    i
                      ? ((this._popin = n), this._popin.hidden.add(this._onPopinHidden))
                      : ((this._page = n),
                        this._previousPage &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  document.body.classList.add('loading'),
                    (this._xhr = (0, h.default)().get(this._router.url)),
                    this._xhr.then(function (i, o) {
              ...
              },
              {
                ...
                value: function () {
                  this._page.isShown &&
                    (this._previousPage.isDestroyed || this._previousPage.destroy(),
        ...
        n(
          ...
          '_onPageHidden',
          [c.default],
          Object.getOwnPropertyDescriptor(r.prototype, '_onPageHidden'),
          r.prototype,
        ),
        n(
          r.prototype,
          '_onPopinHidden',
          [c.default],
          Object.getOwnPropertyDescriptor(r.prototype, '_onPopinHidden'),
          r.prototype,
        ),
        n(
          r.prototype,
          '_onPageShown',
          [c.default],
          Object.getOwnPropertyDescriptor(r.prototype, '_onPageShown'),
          r.prototype,
        ),
        r);
    t.default = d;
    ...
    var n,
      ...
      d =
        ...
        (n = (function () {
          function e() {
            (function (e, t) {
              ...
              (0, u.default)(document.body, 'a:not([target])', 'click', this._onClickLink.bind(this)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (1 !== e.button) {
                      ...
                      history.pushState({ prevented: n, popin: r }, document.title, o);
                    }
                  },
                },
                {
        ...
        (function (e, t, i, o, n) {
          ...
          '_onPopState',
          [c.default],
          Object.getOwnPropertyDescriptor(n.prototype, '_onPopState'),
          n.prototype,
        ),
        n);
    t.default = d;
      ...
      (r.prototype = {
        ...
        (a.prototype = {
          ...
          _registerListener: function (e, t, i, o) {
            ...
            if (-1 !== s) {
              if ((n = this._bindings[s]).isOnce() !== t)
                throw new Error(
                  'You cannot add' +
                    (t ? '' : 'Once') +
                    '() then add' +
  ...
  function (e, t) {
    ...
    function o(e, t, o) {
      ...
      if ('function' != typeof n)
        throw new TypeError('@boundMethod decorator can only be applied to methods not: '.concat(i(n)));
      var r = !1;
      return {
        configurable: !0,
        get: function () {
  ...
  function (e, t) {
    ...
    (t.default = i),
      ...
      (i.dpr = void 0 !== window.devicePixelRatio ? window.devicePixelRatio : 1),
      (i.isTouch = 'ontouchstart' in window || navigator.maxTouchPoints),
      (i.isMobile = window.mobileAndTabletcheck()),
      (i.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream);
    var o = navigator.userAgent.toLowerCase();
    (i.isTablet =
      /(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/.test(
        o,
      )),
      (i.isFirefox = 'undefined' != typeof InstallTrigger),
      (i.isSafari =
        /constructor/i.test(window.HTMLElement) ||
        '[object SafariRemoteNotification]' ===
          (!window.safari || ('undefined' != typeof safari && safari.pushNotification)).toString()),
      (i.isIE = !!document.documentMode),
      (i.isEdge = !i.isIE && !!window.StyleMedia),
      i.isMobile && !i.isTablet && document.body.classList.add('is-mobile'),
      i.isTablet && document.body.classList.add('is-tablet'),
      i.isTouch && document.body.classList.add('is-touch'),
      i.isFirefox && document.body.classList.add('is-firefox'),
      i.isSafari && document.body.classList.add('is-safari'),
      i.isEdge && document.body.classList.add('is-edge'),
      i.isIE && document.body.classList.add('is-ie'),
      i.isIOS && document.body.classList.add('is-ios'),
      'IntersectionObserver' in window ? (i.hasIO = !0) : document.body.classList.add('no-io'),
      (i.resize = function () {
        i.lockResize ||
          ((i.width = document.body.offsetWidth),
          (i.height = window.innerHeight),
          (i.diagonal = Math.sqrt(i.width * i.width + i.height * i.height)),
          (i.centerX = 0.5 * i.width),
          (i.centerY = 0.5 * i.height),
          (i.mobile = i.width < 740));
      }),
      (i.mouseX = 0.5 * window.innerWidth),
      (i.mouseY = 0.5 * window.innerHeight),
      (i.dragX = 0),
      (i.dragY = 0),
      (i.dragStartX = 0),
      (i.dragStartY = 0),
      (i.onTouchStart = function (e) {
        e.targetTouches
          ? ((i.mouseX = e.targetTouches[0].clientX), (i.mouseY = e.targetTouches[0].clientY))
          : e.changedTouches && ((i.mouseX = e.changedTouches[0].clientX), (i.mouseY = e.changedTouches[0].clientY)),
          (i.dragX = 0),
          (i.dragY = 0),
          (i.dragStartX = i.mouseX),
          (i.dragStartY = i.mouseY);
      }),
      (i.onMouseMove = function (e) {
        i.isMobile
          ...
          (i.dragX = i.mouseX - i.dragStartX),
          (i.dragY = i.mouseY - i.dragStartY);
      }),
      (i.scrollY = 0),
      (i.scrollSpeed = 0),
      (i.easedScrollSpeed = 0),
      (i.absEasedScrollSpeed = 0),
      (i.lastMouseX = 0),
      (i.lastMouseY = 0),
      (i.easedMouseX = 0),
      (i.easedMouseY = 0),
      (i.mouseSpeedX = 0),
      (i.mouseSpeedY = 0),
      (i.easedMouseSpeedX = 0),
      (i.easedMouseSpeedY = 0),
      (i.updatePhysics = function () {
        (this.easedScrollSpeed += 0.1 * (i.scrollSpeed - i.easedScrollSpeed)),
          (this.absEasedScrollSpeed += 0.1 * (Math.abs(i.scrollSpeed) - i.absEasedScrollSpeed)),
          ...
          (this.easedMouseSpeedX += 0.03 * (Math.abs(this.mouseSpeedX) - this.easedMouseSpeedX)),
          (this.easedMouseSpeedY += 0.03 * (Math.abs(this.mouseSpeedY) - this.easedMouseSpeedY)),
  ...
  function (e, t, i) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.sitemap = { pages: { default: { class: i(14) }, home: { class: i(33) }, 'not-found': { class: i(35) } } });
  },
  function (e, t, i) {
    'use strict';
    function o(e) {
    ...
    var a,
      ...
      b =
            ...
            l(t, [
              {
                ...
                value: function () {
                  if (
                    ...
                    ((h.default.isSafari && this.previousPage) || (h.default.isIOS && this.previousPage)) &&
                      Array.from(this.dom.querySelectorAll('img')).forEach(function (e) {
                        e.outerHTML = e.outerHTML;
                      }),
                    h.default.isIOS &&
                      this.previousPage &&
                      Array.from(this.dom.querySelectorAll('video')).forEach(function (e) {
                        e.outerHTML = e.outerHTML;
                      }),
                    (h.default.currentPage = this),
                    (h.default.scrollable = this.scrollable),
                    this.initLangBtn(),
              ...
              },
              {
                key: 'resize',
                value: function () {
                  u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'resize', this).call(this),
              ...
              },
              {
                key: 'update',
                value: function () {
                  u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'update', this).call(this),
                    this.scrollLoops.forEach(function (e) {
                      e.update();
                    }),
                    this.blockAnimations &&
              ...
              },
              {
                key: '_show',
                value: function () {
                  0 == (window.pageYOffset || document.documentElement.scrollTop) && (this.scrollable.y = 0),
                    TweenLite.set(this.dom, { autoAlpha: 0 }),
                    TweenLite.to(this.dom, 1.5, { autoAlpha: 1, delay: 0.09, ease: Power4.easeOut }),
              ...
              },
              {
                ...
                value: function () {
                  (this.langList._isVisible = !0),
                    ...
                    document.addEventListener(h.default.isTouch ? 'touchstart' : 'click', this.onClickOutsideLangBtn),
                ...
                value: function () {
                  (this.langList._isVisible = !1),
                    ...
                    document.removeEventListener(
                      h.default.isTouch ? 'touchstart' : 'click',
              ...
              },
              {
                ...
                value: function () {
                  ...
                  h.default.isMobile ||
                    ((this.blockAnimations = []),
                    h.default.isMobile ||
                      ((this.blockAnimationsDom = Array.from(this.dom.querySelectorAll('.block-anim'))),
                      this.blockAnimationsDom.forEach(function (t) {
                        var i = new v.default({ wrapper: t });
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  h.default.isMobile ||
                    Array.from(this.dom.querySelectorAll('.prllx')).forEach(function (t) {
                      new m.default({ scrollable: e.scrollable, wrapper: t });
                    });
                },
              },
              {
                ...
                value: function () {
                  var e = this;
                  (this.scrollLoops = []),
                    (this.scrollLoopsDom = Array.from(this.dom.querySelectorAll('.scroll-loop'))),
                    this.scrollLoopsDom.forEach(function (t) {
                      var i = new y.default({ wrapper: t });
              ...
              },
              {
                ...
                value: function () {
                  (h.default.isMobile && !h.default.isTablet) ||
                    (t.header.onColorSwitch('#FFFFFF'),
                    (this.navColorSwitch = new p.default({
                      defaultColor: '#FFFFFF',
                    ...
                    t = new IntersectionObserver(function (e) {
                      e.forEach(function (e) {
                        if (e.isIntersecting) {
                          ...
                          (i.style.opacity = 0),
                            'VIDEO' == i.nodeName
                              ? (Array.from(i.querySelectorAll('[data-src]')).forEach(function (e) {
                                  e.src = e.dataset.src;
                                }),
                                i.load())
                            ...
                            t.unobserve(i),
                            TweenLite.to(i, 0.5, { autoAlpha: 1, ease: Power2.easeOut });
                        }
                      });
                    });
                  (this.lazyObserver = t),
                    Array.from(this.dom.querySelectorAll('.lazy')).forEach(function (t) {
        ...
        s(
          ...
          'onClickLangBtn',
          [g.default],
          Object.getOwnPropertyDescriptor(a.prototype, 'onClickLangBtn'),
          a.prototype,
        ),
        s(
          a.prototype,
          ...
          [g.default],
          Object.getOwnPropertyDescriptor(a.prototype, 'onClickOutsideLangBtn'),
          a.prototype,
        ),
        s(a.prototype, 'onWheel', [g.default], Object.getOwnPropertyDescriptor(a.prototype, 'onWheel'), a.prototype),
        s(
          a.prototype,
          'hideLangList',
          [g.default],
          Object.getOwnPropertyDescriptor(a.prototype, 'hideLangList'),
          a.prototype,
        ),
        a);
    t.default = b;
        ...
        return (
          ...
          s(t, [
              ...
              value: function () {
                a(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'resize', this).call(this),
                  this.scrollable &&
                    ...
                    (this.scrollable.resize(), (this.height = this.scrollable.height));
              },
            },
            {
              key: 'update',
            ...
            },
            {
              key: 'hide',
              value: function (e) {
                a(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'hide', this).call(this, e),
        ...
        ((n = (function () {
          function e(t, i) {
            (function (e, t) {
              ...
              (this.pageId = this.id),
              (this.startHide = new a.default()),
              (this.hidden = new a.default()),
              (this.startShow = new a.default()),
              (this.shown = new a.default()),
              (this.previousPage = i),
              i &&
                !i.isHidden &&
                ((this._previousPage = i), this._previousPage.hidden.add(this._onPreviousPageHidden.bind(this)));
          }
          return (
            r(e, [
        ...
        (function (e, t, i, o, n) {
          ...
          Object.keys(o).forEach(function (e) {
            ...
            n &&
              ...
              ((r.value = r.initializer ? r.initializer.call(n) : void 0), (r.initializer = void 0)),
            void 0 === r.initializer && (Object.defineProperty(e, t, r), (r = null));
        })(n.prototype, '_hidden', [l.default], Object.getOwnPropertyDescriptor(n.prototype, '_hidden'), n.prototype),
        n);
    t.default = u;
  },
  function (e, t, i) {
    ...
    var a,
      ...
      p =
            ...
            l(t, [
              {
                ...
                value: function (e) {
                  (this.height = this.dom.clientHeight),
                    (this.boundingHeight = e || u.default.height),
                    this._dummy && u.default.mobile
                    ...
                    (void 0 !== this._y
                      ? ((this.deltaY = this._y - this.y),
                        e
                          ...
                          : 'touch' === this._mode &&
                            (this.dragging
                              ? ((this.y += this.deltaY), (this.vy = this.y - this._oy))
                              : ((this.y += this.vy), (this._y = this.y), (this.vy *= this._frictionTouchRelease)),
                            this.y < 0
                              ? ((this.vy = 0), (this.y += (0 - this.y) * (this.dragging ? 0.5 : 0.125)))
                              : this.y > this.height - this.boundingHeight &&
                                ((this.vy = 0),
                                (this.y +=
                                  (this.height - this.boundingHeight - this.y) * (this.dragging ? 0.5 : 0.125))),
                            this.thumb && this._updateThumbPosition()))
                      : (this.y = this._y)),
                    (this.y = ((1e3 * this.y) | 0) / 1e3),
                    this.preventDomUpdate || (this._ox === this.x && this._oy === this.y && !e) || this._updateDom(t),
                  ...
                  (this.dom.style.position = 'fixed'),
                    ...
                    (this._wheelEvent =
                      'onwheel' in document.createElement('div')
                        ...
                        ? 'mousewheel'
                        : 'DOMMouseScroll');
                  var e = !!h.default.hasSupport && { passive: !0 };
                  this.dom.addEventListener('mousedown', this._onMouseDown, e),
                    this.dom.addEventListener('touchstart', this._onTouchStart, e),
                    this.dom.addEventListener('touchmove', this._onTouchMove, !this.prevent && e),
                    this.dom.addEventListener('touchend', this._onTouchEnd, e),
                    this.dom.addEventListener(this._wheelEvent, this._onMouseScroll, e);
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  this.height > this.boundingHeight &&
                    (this.thumb.percent = this._y / (this.height - this.boundingHeight));
                },
              },
              {
                key: '_onMouseDown',
              ...
              },
              {
                ...
                value: function (e) {
                  (this._mode = 'mouse'),
                    e.stopPropagation(),
                    this.thumb &&
                      ((this._y += e ? (1 === e.deltaMode ? 20 * e.deltaY : e.deltaY) : 0),
                      this._applyConstrains(),
              ...
              },
              {
                ...
                set: function (e) {
                  e
                    ...
                    : (this._dummy && (this._dummy.style.display = 'none'), (this.dom.style.willChange = null)),
                    (this.isLocked = !e);
                },
                get: function () {
                  return !this.isLocked;
        ...
        s(
          ...
          '_onMouseDown',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onMouseDown'),
          a.prototype,
        ),
        s(
          a.prototype,
          '_onMouseScroll',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onMouseScroll'),
          a.prototype,
        ),
        s(
          a.prototype,
          '_onTouchStart',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onTouchStart'),
          a.prototype,
        ),
        s(
          a.prototype,
          '_onTouchMove',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onTouchMove'),
          a.prototype,
        ),
        s(
          a.prototype,
          '_onTouchEnd',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onTouchEnd'),
          a.prototype,
        ),
        s(
          a.prototype,
          '_onScroll',
          [f.default],
          Object.getOwnPropertyDescriptor(a.prototype, '_onScroll'),
          a.prototype,
        ),
        a);
    t.default = p;
  ...
  function (e, t) {
    ...
    (i.vendors = { Webkit: 'webkit', Moz: 'moz', O: 'o' }),
      ...
      (i.transform = function (e, t) {
        e &&
          (e.style.transform || (e.style.transform = e.style.webkitTransform || e.style.mozTransform),
          (e.style.transform = t));
      }),
      (i.transformOrigin = function (e, t) {
        e &&
          (e.style.transformOrigin ||
            (e.style.transformOrigin = e.style.webkitTransformOrigin || e.style.mozTransformOrigin),
          (e.style.transformOrigin = t));
      }),
      (i.transition = function (e, t) {
        e &&
          (e.style.transition || (e.style.transition = e.style.webkitTransition || e.style.mozTransition),
    ...
    var s,
      ...
      f =
        ((s = (function (e) {
          function t(e, i) {
            ...
            return (
              (o.page = i),
              (o.height = void 0),
              (o.eased = !h.default.isMobile),
              (o.isNative = h.default.isMobile),
              ...
              (o._tlElts = []),
              h.default.isMobile ||
                ((o.dom.style.position = 'fixed'), o.bindImagesLoad(), setTimeout(o.checkPageHeight, 60)),
              o
            );
          }
          return (
              ...
              },
              {
                ...
                value: function () {
                  if (!this.fixedScroll) {
                    ...
                    (this.height = t < h.default.height ? h.default.height : t),
                      this.resetTimeline(),
                      this.isNative ||
                        ((document.body.style.height = this.height + 'px'),
                        t <= h.default.height || ((e.style.overflowY = 'scroll'), this.updateDom()));
                  }
                },
              },
              {
                ...
                value: function () {
                  h.default.isMobile ||
                    ...
                    (document.body.style.height = h.default.height + 'px'),
                    (this.isLocked = !0));
                },
              },
              {
                ...
                value: function () {
                  if (!this.isLocked) {
                    ...
                    (this.vy = e - this.y),
                      ...
                      (h.default.scrollSpeed = this.vy),
                      (h.default.scrollY = this.y);
                  }
                },
              },
              {
                ...
                value: function () {
                  this.isNative ||
                    ((this.scrollRatio = this.y / (this.height - h.default.height)),
                    this.scrollRatio < 0 ? (this.scrollRatio = 0) : this.scrollRatio > 1 && (this.scrollRatio = 1),
                    this._tl && this._tl.progress(this.scrollRatio),
                    this.fixedScroll || TweenLite.set(this.dom, { y: -this._y }));
                },
              },
              {
                key: 'scrollTo',
              ...
              },
              {
                ...
                value: function (e) {
                  (e = Math.round(e)),
                    ...
                    this.isLocked ||
                      (this.height < h.default.height
                        ? (this.body.style.height = h.default.height + 'px')
                        : ((this.body.style.height = this.height + 'px'), (this.html.style.overflowY = 'scroll')),
                      this.updateDom());
                },
              },
              {
                ...
                value: function () {
                  this._tl
                    ? (this.clearTimeline(this._tl), (this._tl = new TimelineLite({ paused: !0 })))
        ...
        (function (e, t, i, o, n) {
          ...
          'checkPageHeight',
          [d.default],
          Object.getOwnPropertyDescriptor(s.prototype, 'checkPageHeight'),
          s.prototype,
        ),
        s);
    t.default = f;
          ...
          'undefined' != typeof window &&
            ...
            (l.deviceType = (function (e, t, i, o) {
              return e && (t || i)
                ...
                ? 'touchOnly'
                : 'mouseOnly';
            })(l.hasTouch, l.state.detectHover.anyHover, l.state.detectPointer.anyFine, l.state)),
            (l.hasMouse = 'touchOnly' !== l.deviceType),
            (l.primaryInput =
              ('mouseOnly' === l.deviceType ? 'mouse' : 'touchOnly' === l.deviceType && 'touch') ||
            ...
            /windows/.test(window.navigator.userAgent.toLowerCase()) &&
              ...
              l.hasTouch &&
              ((l.deviceType = 'hybrid'), (l.hasMouse = !0), (l.primaryInput = 'mouse')));
        },
      };
    ...
    var i = {
      update: function () {
        'undefined' != typeof window &&
          ...
          (i.anyNone =
            window.matchMedia('(any-hover: none)').matches || window.matchMedia('(any-hover: on-demand)').matches));
      },
    };
    i.update(), (t.default = i);
  },
  ...
  function (e, t) {
    ...
    var i = {
      update: function () {
        'undefined' != typeof window &&
          ((i.hasSupport = 'ontouchstart' in window), (i.browserSupportsApi = Boolean(window.TouchEvent)));
      },
    };
    i.update(), (t.default = i);
  },
    ...
    var n,
      ...
      l =
        ((n = (function () {
          function e() {
            if (
              ...
              s.default.isMobile & !s.default.isTablet)
            ) {
            ...
            r(e, [
              {
                key: 'show',
                value: function () {
                  TweenLite.to(this.dom, 1, { autoAlpha: 1, ease: Power4.easeOut });
                },
              },
              {
                key: 'onColorSwitch',
        ...
        (function (e, t, i, o, n) {
          ...
          'onColorSwitch',
          [a.default],
          Object.getOwnPropertyDescriptor(n.prototype, 'onColorSwitch'),
          n.prototype,
        ),
        n);
    t.default = l;
      ...
      s =
        ...
        function e() {
          (function (e, t) {
            ...
            (this.dom = document.querySelector('.footer'));
        });
    t.default = s;
  },
  function (e, t, i) {
      ...
      r = (function () {
        function e(t) {
          (function (e, t) {
            ...
            (this.switches = Array.from(n.default.currentPage.dom.querySelectorAll(this.selector))),
          ...
          o(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                var t =
                  '1px 0px ' + (this.element.offsetTop + 0.5 * this.element.offsetHeight - n.default.height) + 'px';
                (this._firstChange = !1),
                      ...
                      t.forEach(function (t) {
                        if (t.target._firstObserve)
                          ...
                          (t.target._firstObserve = !0),
                            t.isIntersecting &&
                              t.rootBounds.height - t.boundingClientRect.y <= t.boundingClientRect.height &&
                              (e.callback(t.target._color), (e._firstChange = !0));
            ...
            r(e, [
              {
                ...
                value: function () {
                  for (
                    this.loopEltCount = 1, this.loopWidth = this.span.offsetWidth;
                    this.loopWidth < this.wrapper.offsetWidth;

                  )
                    (this.loopWidth += this.span.offsetWidth), (this.loopEltCount += 1);
                ...
                value: function (e) {
                  ...
                  return (
                    e.parentElement != s.default.scrollable.dom &&
                      (e.parentElement._gsTransform && (t += e.parentElement._gsTransform.y),
              ...
              },
              {
                ...
                value: function () {
                  (this.pageY = this.getPageY(this.wrapper)),
                    (this.loopWidth = this.span.offsetWidth * this.loopEltCount);
                },
              },
              {
                key: 'x',
                ...
                set: function (e) {
                  ...
                  this.debug && console.log(t, s.default.height + this.wrapper.offsetHeight),
        ...
        (function (e, t, i, o, n) {
          ...
          Object.keys(o).forEach(function (e) {
            ...
            n &&
              ...
              ((r.value = r.initializer ? r.initializer.call(n) : void 0), (r.initializer = void 0)),
            void 0 === r.initializer && (Object.defineProperty(e, t, r), (r = null));
        })(n.prototype, 'init', [a.default], Object.getOwnPropertyDescriptor(n.prototype, 'init'), n.prototype),
        n);
    t.default = l;
  },
  function (e, t, i) {
      ...
      r = (function () {
        function e(t) {
          (function (e, t) {
            ...
            (this.margin = this.justBellow ? -1 : 0.12 * n.default.width),
          ...
          o(e, [
            ...
            },
            {
              ...
              value: function () {
                if (!this.disabled) {
                  ...
                  e < n.default.height - 0.7 * this.wrapper.offsetHeight
                    ? this.isShown || this.show()
                    : e > n.default.height + this.margin && this.isShown && this.hide(),
                    this.debug && console.log(e, n.default.height);
                }
              },
            },
            {
              key: 'show',
              value: function () {
                if (((this.isShown = !0), this.oneTime && (this.disabled = !0), this.wrapper._tl))
                  return TweenLite.set(this.wrapper, { autoAlpha: 1 }), void this.wrapper._tl.play();
                this.slide
                  ? (TweenLite.to(this.wrapper, 0.5, { autoAlpha: 1, ease: Power2.easeInOut }),
                    TweenLite.fromTo(this.wrapper, 1.5, { y: 0.5 * n.default.height }, { y: 0, ease: Expo.easeOut }),
                    TweenLite.fromTo(this.wrapper, 1.5, { y: 350 }, { y: 0, ease: Expo.easeOut }))
                  : TweenLite.to(this.wrapper, 2, { autoAlpha: 1, ease: Power2.easeOut });
              },
            },
            {
              key: 'hide',
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.offsetTop;
                return (
                  e.parentElement != n.default.scrollable.dom &&
                    (this.debug && console.log(e, e.offsetTop, e.offsetHeight), (t += this.getPageY(e.parentElement))),
                  t
                );
              },
            },
            {
              ...
              value: function () {
                var e = 0;
                return (
                  this.wrapper.parentElement._gsTransform && (e += this.wrapper.parentElement._gsTransform.y),
                  this.wrapper._gsTransform && (e += this.wrapper._gsTransform.y),
                  this.pageY - n.default.scrollY + e
                );
              },
            },
          ]),
          ...
          o(e, [
            {
              ...
              value: function () {
                ...
                if (0 == o) this.scrollable._tl.fromTo(this.elt, r, { y: 0 }, { y: 2 * e, ease: Power0.easeInOut }, 0);
                else {
                  var s = new TimelineLite({ paused: !1 });
                  if (((r = (n.default.height + this.wrapper.offsetHeight) * i), o < n.default.height))
                    s.fromTo(this.elt, r, { y: -e + t }, { y: e + t, ease: Power0.easeInOut }, 0),
                      this.scrollable._tl.add(s, 0);
                  else {
                    var a = (o - n.default.height) * i;
                    this.forceEnd
                      ? (s.fromTo(this.elt, r, { y: 2 * -e }, { y: 0, ease: Power0.easeInOut }, 0),
                        this.scrollable._tl.add(s, this.scrollable._tl.duration() - r))
                      : (s.fromTo(this.elt, r, { y: -e + t }, { y: e + t, ease: Power0.easeInOut }, 0),
                        this.scrollable._tl.add(s, a));
                  }
                }
              },
            },
    ...
    var a,
      ...
      p =
            ...
            l(t, [
              {
                ...
                value: function () {
                  var e = this;
                  c.default.isMobile && !c.default.isTablet && this.dom.querySelector('.coin_3').remove(),
                    this.initAnimations(),
                    u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'init', this).call(this);
                  ...
                  (this.introVideo = i.querySelector('.intro')),
                    ...
                    this.previousPage
                      ...
                      : this.skipIntro
                      ? ((document.body.style.background = '#151515'), h.default.header.show(), this.replayIntro())
                      : this.playIntro();
                },
              },
              {
                ...
                value: function () {
                  this.initIntro(),
                    ...
                    this.introVideo.addEventListener('canplay', this.startDomAnim),
                    this.introLoop.addEventListener('playing', this.onLoopStarted),
              ...
              },
              {
                key: 'onLoopStarted',
                value: function (e) {
                  this.introLoop.removeEventListener('playing', this.onLoopStarted),
                ...
                value: function () {
                  u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'update', this).call(this),
                    ...
                    !this.haveScrolled &&
                      this.scrollable.y > 0 &&
                      ((this.haveScrolled = !0),
                      TweenLite.to(this._arrow, 0.5, { autoAlpha: 0, y: 30, ease: Power2.easeIn }));
                },
              },
              {
                key: '_show',
              ...
              },
              {
                ...
                value: function () {
                  ...
                  n.words.forEach(function (t, i) {
                    TweenLite.set(t, { scale: 0.7, transformOrigin: '50% 80%', autoAlpha: 0 }),
                      e.intro.to(t, 0, { autoAlpha: 1 }, 0.55 + 0.15 * i),
                      e.intro.to(t, 0.15, { scale: 1, ease: Expo.easeInOut }, 0.65 + 0.15 * i);
                  }),
                    o[1] &&
                      new SplitText(o[1], { type: 'words' }).words.forEach(function (t, i) {
                        TweenLite.set(t, { scale: 0.7, transformOrigin: '50% 80%', autoAlpha: 0 }),
                          e.intro.to(t, 0, { autoAlpha: 1 }, 2.98 + 0.15 * i),
                          e.intro.to(t, 0.15, { scale: 1, ease: Expo.easeInOut }, 3.08 + 0.15 * i);
                      }),
                    s.words.forEach(function (t, i) {
                      TweenLite.set(t, { autoAlpha: 0 }), e.intro.to(t, 0, { autoAlpha: 1 }, 2.98 + 0.7 + 0.09 * i);
                    }),
                    this.intro.add(function () {
                    ...
                    this.intro.add(function () {
                      e.haveScrolled || TweenLite.to(e._arrow, 1.5, { autoAlpha: 1, y: 0, ease: Expo.easeInOut });
                    }, 2.5);
                },
              },
              {
                ...
                value: function () {
                  if (!c.default.isMobile) {
                    ...
                    new SplitText(o, { type: 'lines' }).lines.forEach(function (t, i) {
                      TweenLite.set(t, { y: c.default.height, scale: 0, transformOrigin: '50% 80%' }),
                        e.to(t, 1.6, { scale: 1, ease: Elastic.easeOut.config(1, 0.45) }, 0.05 + 0.15 * i),
                        e.to(t, 0.5, { y: 0, ease: Power4.easeOut }, 0 + 0.15 * i);
                    }),
                      Array.from(t.querySelectorAll('.coins')).forEach(function (t, i) {
                        var o = t.querySelector('video');
                        TweenLite.set(o, { y: 0 * c.default.width, scale: 0, transformOrigin: '50% 50%' }),
                          e.to(o, 1.5, { scale: 1, ease: Elastic.easeOut.config(1, 0.4) }, 0.3 + 0.1 * i),
                          e.to(o, 0.5, { y: 0, ease: Power4.easeOut }, 0.3 + 0.1 * i);
                      }),
                      new SplitText(t.querySelectorAll('.baseline'), { type: 'words' }).words.forEach(function (t, i) {
                        TweenLite.set(t, { autoAlpha: 0 }), e.to(t, 0, { autoAlpha: 1 }, 0.98 + 0.09 * i);
                      });
                    var n = t.querySelectorAll('.home_create_facts');
                    e.fromTo(n, 1.5, { autoAlpha: 0 }, { autoAlpha: 1, ease: Power2.easeInOut }, 0.5), (i._tl = e);
                    var r = this.dom.querySelector('.home_scan'),
                      s = r.querySelector('.home_scan_qr-code'),
                      a = r.querySelector('.home_scan_qr-code-wrapper');
                    this.qrBall = new f.default({ wrapper: a, dom: s, scale: 1 });
                  }
                },
              },
            ]),
        ...
        s(
          ...
          'startDomAnim',
          [d.default],
          Object.getOwnPropertyDescriptor(a.prototype, 'startDomAnim'),
          a.prototype,
        ),
        s(
          a.prototype,
          'onLoopStarted',
          [d.default],
          Object.getOwnPropertyDescriptor(a.prototype, 'onLoopStarted'),
          a.prototype,
        ),
        a);
    t.default = p;
        ...
        function e(t) {
          ...
          (function (e, t) {
            ...
            new IntersectionObserver(
              function (e) {
                e.forEach(function (e) {
                  e.isIntersecting && r.default.scrollable.y > 0
                    ? (TweenLite.to(i, 1.2, { aScale: 1, ease: Elastic.easeOut }),
                      TweenLite.to(i, 1.4, { sinScaleAmp: 1, ease: Power1.easeIn }),
                      TweenLite.to([i.dom, i.logoBall, i.menuBall], 0.24, { autoAlpha: 1, ease: Power4.easeOut }),
                      (i.isVisible = !0))
                    : (TweenLite.to(i, 0.3, { aScale: 1e-4, ease: Back.easeIn }),
                      TweenLite.to(i, 0.3, { sinScaleAmp: 0, ease: Power4.easeOut }),
            ...
            this.qrCode.addEventListener('mouseenter', function (e) {
              TweenLite.fromTo(i.focus, 0.2, { scale: 1.5 }, { scale: 1, ease: Back.easeOut }),
          ...
          n(e, [
            {
              ...
              value: function () {
                ...
                this.dom.parentElement._gsTransform && (t += -this.dom.parentElement._gsTransform.y),
                  (t += r.default.mouseY - 0.5 * this.dom.offsetHeight);
                var i = e - this.x,
                  o = t - this.y;
            ...
            },
            {
              ...
              set: function (e) {
                if (((this._x = e), this.isVisible)) {
                  TweenLite.set(this.dom, { x: e }), TweenLite.set(this.qrCode, { x: (1 * -e) / this.scale });
                  var t = e - this.logo.offsetLeft + r.default.centerX - 0.5 * this.dom.offsetWidth;
                  TweenLite.set(this.logoBall, { x: t }),
                    (t = e - this.menu.parentElement.offsetLeft + r.default.centerX - 0.5 * this.dom.offsetWidth),
            ...
            },
            {
              ...
              set: function (e) {
                if (((this._y = e), this.isVisible)) {
                  TweenLite.set(this.dom, { y: e }), TweenLite.set(this.qrCode, { y: (1 * -e) / this.scale });
                  var t = e - (r.default.scrollable.y - this.pageY + this.logo.offsetTop);
                  this.dom.parentElement._gsTransform && (t += this.dom.parentElement._gsTransform.y),
                    TweenLite.set(this.logoBall, { y: t }),
                    (t =
                      e -
                      (r.default.scrollable.y - this.pageY + this.menu.offsetTop + this.menu.parentElement.offsetTop)),
                    this.dom.parentElement._gsTransform && (t += this.dom.parentElement._gsTransform.y),
            ...
            },
            {
              ...
              set: function (e) {
                (this._scale = e),
                  this.isVisible &&
                    (e < 0.001 && (e = 0.001),
                    TweenLite.set([this.dom, this.logoBall, this.menuBall], { scale: e }),
            ...
            },
            {
              ...
              value: function (e) {
                for (var t = e.length, i = void 0, o = void 0; t; )
                  (o = Math.floor(Math.random() * t--)), (i = e[t]), (e[t] = e[o]), (e[o] = i);
                return e;
              },
            },
            {
                    ...
                    if ('select-multiple' === o.type)
                      for (var n = 0; n < o.options.length; n++)
                        o.options[n].selected &&
                          t.push(encodeURIComponent(o.name) + '=' + encodeURIComponent(o.options[n].value));
                    else
                      (('checkbox' !== o.type && 'radio' !== o.type) || o.checked) &&
                        t.push(encodeURIComponent(o.name) + '=' + encodeURIComponent(o.value));
                }
                return t.join('&');
              },
            },
      ...
      Array.from ||
        (Array.from = (function () {
          ...
          return function (e) {
            ...
            for (var a, l = o(n.length), u = t(i) ? Object(new i(l)) : new Array(l), c = 0; c < l; )
              (a = n[c]), (u[c] = s ? (void 0 === r ? s(a, c) : s.call(r, a, c)) : a), (c += 1);
            return (u.length = l), u;
          };
        })());
  },
    ...
    !(function (r, s) {
      ...
      (o = function () {
        ...
        function i(e, t, i, r) {
          ...
          return (
            l.open(e, c, !0),
            (l.withCredentials = r.hasOwnProperty('withCredentials')),
            n(l, r.headers, i),
            l.addEventListener('readystatechange', s(a, l), !1),
            l.send(u(i) ? JSON.stringify(i) : i),
            (a.abort = function () {
              return l.abort();
            }),
            a
        ...
        function n(e, t, i) {
          r((t = t || {})) || (t['Content-Type'] = u(i) ? 'application/json' : 'application/x-www-form-urlencoded'),
        ...
        function s(e, t) {
          return function i() {
            t.readyState === t.DONE &&
              ...
              t.status >= 200 && t.status < 300 ? e.then.apply(e, a(t)) : e.catch.apply(e, a(t)));
          };
        }
        function a(e) {
          var t;
          ...
          return Object.keys(e)
            .map(function (i) {
              if (e.hasOwnProperty(i) && void 0 !== e[i]) {
                var o = e[i];
                return (
                  (i = t ? t + '[' + i + ']' : i), null !== o && 'object' == typeof o ? c(o, i) : h(i) + '=' + h(o)
                );
              }
            })
            .filter(Boolean)
