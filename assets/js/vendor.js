...
!(function () {
          ...
          if ('none' != window.getComputedStyle(e).display) {
            for (var r, n, s, a, l, h, p, f, c = o(e), D = u(e), _ = !1; !_; ) {
              ...
              if (
                (D == this.root || D == t
                  ? ((_ = !0), (d = i))
                  : D != t.body && D != t.documentElement && 'visible' != m.overflow && (d = o(D)),
                d &&
                  ((r = d),
                  (n = c),
                  ...
                  !(c = 0 <= (p = (h = Math.min(r.right, n.right)) - l) &&
                    0 <= f && { top: s, bottom: a, left: l, right: h, width: p, height: f })))
              )
                break;
              D = u(D);
            }
  ...
  (function (t, e) {
    ...
    var l,
      ...
      y = {},
      v = function (r, s, a, u) {
        (this.sc = y[r] ? y[r].sc : []), ((y[r] = this).gsClass = null), (this.func = a);
        var l = [];
        (this.check = function (h) {
          for (var p, f, c, D, _ = s.length, d = _; -1 < --_; )
            (p = y[s[_]] || new v(s[_], [])).gsClass ? ((l[_] = p.gsClass), d--) : h && p.sc.push(this);
          if (0 === d && a) {
            if (
              ...
              if (((n[c] = i[c] = D), 'undefined' != typeof module && module.exports))
                if (r === e) for (_ in ((module.exports = i[e] = D), i)) D[_] = i[_];
                else i[e] && (i[e][c] = D);
              else
    ...
    var F = [0, 0, 1, 1],
      T = C(
        'easing.Ease',
        function (t, e, i, r) {
          (this._func = t), (this._type = i || 0), (this._power = r || 0), (this._params = e ? F.concat(e) : F);
        },
        !0,
      ),
      w = (T.map = {}),
      b = (T.register = function (t, e, i, r) {
        for (
          var n, s, o, a, u = e.split(','), l = u.length, h = (i || 'easeIn,easeOut,easeInOut').split(',');
          -1 < --l;

        )
          for (s = u[l], n = r ? C('easing.' + s, null, !0) : d.easing[s] || {}, o = h.length; -1 < --o; )
            (a = h[o]), (w[s + '.' + a] = w[a + s] = n[a] = t.getRatio ? t : t[a] || new t());
      });
    for (
    ...
    ((p = E.prototype).addEventListener = function (t, e, i, r, n) {
      ...
      var s,
        ...
        a = this._listeners[t],
        u = 0;
      for (this !== f || c || f.wake(), null == a && (this._listeners[t] = a = []), o = a.length; -1 < --o; )
      ...
      (p.dispatchEvent = function (t) {
        var e,
          ...
          n = this._listeners[t];
        if (n)
          for (1 < (e = n.length) && (n = n.slice(0)), i = this._eventTarget; -1 < --e; )
    ...
    for (h = (l = ['ms', 'moz', 'webkit', 'o']).length; -1 < --h && !P; )
      (P = t[l[h] + 'RequestAnimationFrame']),
        (O = t[l[h] + 'CancelAnimationFrame'] || t[l[h] + 'CancelRequestAnimationFrame']);
    C('Ticker', function (t, e) {
      var i,
        ...
        d = function (t) {
          ...
          D < u && (h += u - _),
            ...
            (l.time = (A - h) / 1e3),
            (e = l.time - a),
            (!i || 0 < e || !0 === t) && (l.frame++, (a += e + (o <= e ? 0.004 : o - e)), (r = !0)),
            !0 !== t && (s = n(d)),
      ...
      E.call(l),
        ...
        (l.lagSmoothing = function (t, e) {
          return arguments.length ? ((D = t || 1e8), void (_ = Math.min(e, D, 0))) : D < 1e8;
        }),
        (l.sleep = function () {
          null != s && (p && O ? O(s) : clearTimeout(s), (n = u), (s = null), l === f && (c = !1));
        }),
        (l.wake = function (t) {
          null !== s ? l.sleep() : t ? (h += -A + (A = S())) : 10 < l.frame && (A = S() - D + 5),
            (n =
              0 === i
                ? u
                : p && P
    ...
    (f = k.ticker = new d.Ticker()),
      ...
      (p._paused = !1);
    var R = function () {
      c && 2e3 < S() - A && ('hidden' !== (r || {}).visibilityState || !f.lagSmoothing()) && f.wake();
        ...
        if (this._timeline) {
          if ((t < 0 && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming)) {
            ...
            if (
              (r < t && !i && (t = r),
              (this._startTime =
                (this._paused ? this._pauseTime : n._time) - (this._reversed ? r - t : t) / this._timeScale),
      ...
      (p.timeScale = function (t) {
        ...
        for (
          t = t || m,
            this._timeline &&
              this._timeline.smoothChildTiming &&
              ((i = (e = this._pauseTime) || 0 === e ? e : this._timeline.totalTime()),
        ...
        return (
          t != this._paused &&
            ...
            !t &&
              ...
              this._initted &&
              this.duration() &&
              ((e = r.smoothChildTiming ? this._totalTime : (e - this._startTime) / this._timeScale),
    ...
    var I = C(
      'TweenLite',
      function (e, i, r) {
        if ((k.call(this, i, r), (this.render = I.prototype.render), null == e)) throw 'Cannot tween a null target.';
        this.target = e = 'string' != typeof e ? e : I.selector(e) || e;
        var n,
          s,
          o,
          u = e.jquery || (e.length && e !== t && e[0] && (e[0] === t || (e[0].nodeType && e[0].style && !e.nodeType))),
          l = this.vars.overwrite;
        if (
          ((this._overwrite = l = null == l ? Z[I.defaultOverwrite] : 'number' == typeof l ? l >> 0 : Z[l]),
          (u || e instanceof Array || (e.push && g(e))) && 'number' != typeof e[0])
        )
          for (this._targets = o = a(e), this._propLookup = [], this._siblings = [], n = 0; n < o.length; n++)
            (s = o[n])
              ? 'string' != typeof s
                ? s.length && s !== t && s[0] && (s[0] === t || (s[0].nodeType && s[0].style && !s.nodeType))
                  ...
                  : ((this._siblings[n] = it(s, this, !1)),
                    1 === l && 1 < this._siblings[n].length && rt(s, this, null, 1, this._siblings[n]))
                : 'string' == typeof (s = o[n--] = I.selector(s)) && o.splice(n + 1, 1)
              : o.splice(n--, 1);
        else
          (this._propLookup = {}),
            (this._siblings = it(e, this, !1)),
            1 === l && 1 < this._siblings.length && rt(e, this, null, 1, this._siblings);
    ...
    function z(t, e, i, r, n, s, o, a, u) {
      ...
      return (
        ('number' == typeof p && ('number' == typeof r || f)) ||
          (o || isNaN(p) || (!f && isNaN(r)) || 'boolean' == typeof p || 'boolean' == typeof r
            ? ((c.fp = o),
              (c = {
                t: X(
                  p,
                  f ? parseFloat(c.s) + c.c + (c.s + '').replace(/[0-9\-\.]/g, '') : r,
    ...
    var Y = [],
      ...
      V = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
      W = /[\+-]=-?[\.\d]/,
      U = (I._internals = { isArray: g, isSelector: M, lazyTweens: Y, blobDif: X }),
      q = (I._plugins = {}),
      H = (U.tweenLookup = {}),
      G = 0,
      Q = (U.reservedProps = {
      ...
      tt = (U.lazyRender = function () {
        var t,
          ...
          i = Y.length;
        for (j = {}, t = 0; t < i; t++)
          (e = Y[t]) && !1 !== e._lazy && (e.render(e._lazy[0], e._lazy[1], !0), (e._lazy = !1));
        Y.length = 0;
      });
    function et(t, e, i, r) {
      var n,
      ...
      (k._updateRoot = I.render =
        function () {
          ...
          if (
            ...
            if ((!(i = K._first) || i._paused) && I.autoSleep && !$._first && 1 === f._listeners.tick.length) {
    ...
    var it = function (t, e, i) {
        var r,
          ...
          s = t._gsTweenID;
        if (
          (H[s || (t._gsTweenID = s = 't' + G++)] || (H[s] = { target: t, tweens: [] }),
          ...
          (a = n[s]) === e ||
            ...
            (a._timeline !== e._timeline
              ...
              : a._startTime <= h &&
                ...
                (((c || !a._initted) && h - a._startTime <= 2e-8) || (p[f++] = a)));
        for (s = f; -1 < --s; )
          if (
            ((u = (a = p[s])._firstPT),
    ...
    (p._init = function () {
      ...
      (p._initProps = function (e, i, r, n, s) {
        ...
        this.vars))
          ...
          else if (q[o] && (l = new q[o]())._onInitTween(e, this.vars[o], this, s)) {
            for (
              this._firstPT = h =
                { _next: this._firstPT, t: l, p: 'setRatio', s: 0, c: 1, f: 1, n: o, pg: 1, pr: l._priority, m: 0 },
          ...
          } else i[o] = z.call(this, e, o, 'get', p, o, 0, null, this.vars.stringFilter, s);
        return n && this._kill(n, e)
          ? this._initProps(e, i, r, n, s)
          : 1 < this._overwrite && this._firstPT && 1 < r.length && rt(e, this, i, this._overwrite, r)
      ...
      (p.render = function (t, e, i) {
        ...
        if (l - m <= t && 0 <= t)
          (a._totalTime = a._time = l),
            ...
            a._reversed || ((r = !0), (n = 'onComplete'), (i = i || a._timeline.autoRemoveChildren)),
            0 !== l ||
              (!a._initted && a.vars.lazy && !i) ||
              (a._startTime === a._timeline._duration && (t = 0),
              (h < 0 || (t <= 0 && -m <= t) || (h === m && 'isPause' !== a.data)) &&
                h !== t &&
          ...
          (a._totalTime = a._time = 0),
            ...
            (0 !== u || (0 === l && 0 < h)) && ((n = 'onReverseComplete'), (r = a._reversed)),
            -m < t
              ? (t = 0)
              : t < 0 &&
                ((a._active = !1),
          ...
          (1 === f || (3 === f && 0.5 <= p)) && (p = 1 - p),
            ...
            (a.ratio = 1 === f ? 1 - p : 2 === f ? p : t / l < 0.5 ? p / 2 : 1 - p / 2);
        ...
        if (a._time !== u || i) {
          if (!a._initted) {
            ...
            if (!i && a._firstPT && ((!1 !== a.vars.lazy && a._duration) || (a.vars.lazy && !a._duration)))
              return (a._time = a._totalTime = u), (a._rawPrevTime = h), Y.push(a), void (a._lazy = [t, e]);
            a._time && !r
              ? (a.ratio = a._ease.getRatio(a._time / l))
              : r && a._ease._calcEnd && (a.ratio = a._ease.getRatio(0 === a._time ? 0 : 1));
          }
          for (
            !1 !== a._lazy && (a._lazy = !1),
              a._active || (!a._paused && a._time !== u && 0 <= t && (a._active = !0)),
              0 === u &&
                (a._startAt && (0 <= t ? a._startAt.render(t, !0, i) : (n = n || '_dummyGS')),
                !a.vars.onStart || (0 === a._time && 0 !== l) || e || a._callback('onStart')),
              s = a._firstPT;
            s;
          ...
          a._onUpdate &&
            ...
            !n ||
              ...
              r && (a._timeline.autoRemoveChildren && a._enabled(!1, !1), (a._active = !1)),
              !e && a.vars[n] && a._callback(n),
              0 === l && a._rawPrevTime === m && o !== m && (a._rawPrevTime = 0));
        }
      }),
      ...
      (p.invalidate = function () {
        ...
        return (
          ...
          this.vars.immediateRender && ((this._time = -m), this.render(t, !1, !1 !== this.vars.lazy)),
          this
        );
      }),
      (p._enabled = function (t, e) {
        if ((c || f.wake(), t && this._gc)) {
          var i,
            r = this._targets;
          if (r) for (i = r.length; -1 < --i; ) this._siblings[i] = it(r[i], this, !0);
      ...
      (I.getTweensOf = function (t, e) {
        if (null == t) return [];
        var i, r, n, s;
        if (((t = 'string' != typeof t ? t : I.selector(t) || t), (g(t) || M(t)) && 'number' != typeof t[0])) {
    ...
    if (
      ...
      for (p in y) y[p].func || t.console.log('GSAP encountered missing dependency: ' + p);
    }
    c = !1;
  })(
    ...
    _gsScope._gsDefine(
      ...
      function (t, e, i) {
        function r(t) {
          ...
          s))
            (i = s[r]), f(i) && -1 !== i.join('').indexOf('{self}') && (s[r] = n._swapSelfInParams(i));
          ...
          return function (t, l, h) {
            ...
            if (!x) {
              if (!(y = 'auto' === e.grid ? 0 : (e.grid || [1 / 0])[0])) {
                for (m = -1 / 0; m < (m = h[y++].getBoundingClientRect().left) && y < v; );
                y--;
              }
              for (
                x = s[v] = [],
                ...
                (c = (d % y) - p),
                  (D = f - ((d / y) | 0)),
                  (x[d] = _ = a ? Math.abs('y' === a ? D : c) : Math.sqrt(c * c + D * D)),
                  m < _ && (m = _),
                  _ < g && (g = _);
              (x.max = m - g),
                (x.min = g),
                (x.v = v = e.amount || e.each * (v < y ? v : a ? ('y' === a ? v / y : y) : Math.max(y, v / y)) || 0),
                (x.b = v < 0 ? n - v : n);
            }
            return (v = (x[t] - x.min) / x.max), x.b + (i ? i.getRatio(v) : v) * x.v;
          };
        }
        var u = 1e-8,
          l = i._internals,
        ...
        return (
          ...
          (m.from = function (t, e, r, n) {
            return this.add(((r.repeat && _.TweenMax) || i).from(t, e, o(0, r)), n);
          }),
          (m.fromTo = function (t, e, r, n, s) {
            var a = (n.repeat && _.TweenMax) || i;
            return (n = o(0, n, r)), e ? this.add(a.fromTo(t, e, r, n), s) : this.set(t, n, s);
          }),
          (m.staggerTo = function (t, e, o, u, l, h, f, c) {
            ...
            for (
              ...
              (D = n(o)),
                ...
                y && (s(D, t, _), null != D.duration && ((e = D.duration), delete D.duration)),
                d.to(t[_], e, D, m(_, t[_], t));
            return this.add(d, l);
          }),
          (m.staggerFrom = function (t, e, i, r, n, s, a, u) {
            return (i.runBackwards = !0), this.staggerTo(t, e, o(0, i), r, n, s, a, u);
          }),
          (m.staggerFromTo = function (t, e, i, r, n, s, a, u, l) {
            return (r.startAt = i), this.staggerTo(t, e, o(0, r, i), n, s, a, u, l);
          }),
          ...
          (m.add = function (n, s, o, a) {
            var u,
              ...
              D,
              _ = this;
            if (('number' != typeof s && (s = _._parseTimeOrLabel(s, 0, !0, n)), !(n instanceof t))) {
              if (n instanceof Array || (n && n.push && f(n))) {
                for (o = o || 'normal', a = a || 0, u = s, l = n.length, h = 0; h < l; h++)
            ...
            if (
              ...
              (n._time || (!n._duration && n._initted)) &&
                ...
                (!n._duration || 1e-5 < Math.abs(Math.max(0, Math.min(n.totalDuration(), u))) - n._totalTime) &&
                  n.render(u, !1, !1)),
              (_._gc || _._time === _._duration) && !_._paused && _._duration < _.duration())
            )
              for (D = (c = _).rawTime() > n._startTime; c._timeline; )
                D && c._timeline.smoothChildTiming ? c.totalTime(c._totalTime, !0) : c._gc && c._enabled(!0, !1),
                  (c = c._timeline);
            return _;
          }),
          (m.remove = function (e) {
          ...
          (m._parseTimeOrLabel = function (e, i, r, n) {
            ...
            if (n instanceof t && n.timeline === this) this.remove(n);
              ...
              for (o = n.length; -1 < --o; ) n[o] instanceof t && n[o].timeline === this && this.remove(n[o]);
            if (
              ((s =
                'number' != typeof e || i
            ...
            if (((i = i || 0), 'string' != typeof e || (!isNaN(e) && null == this._labels[e]))) null == e && (e = s);
              ...
              (i = parseInt(e.charAt(o - 1) + '1', 10) * Number(e.substr(o + 1))),
                (e = 1 < o ? this._parseTimeOrLabel(e.substr(0, o - 1), 0, r) : s);
            }
            return Number(e) + i;
          }),
          (m.seek = function (t, e) {
          ...
          (m.render = function (t, e, i) {
            ...
            if ((_ !== f._time && (t += f._time - _), d - u <= t && 0 <= t))
              (f._totalTime = f._time = d),
                f._reversed ||
                  ...
                  0 === f._duration &&
                    ((t <= 0 && -u <= t) || f._rawPrevTime < 0 || f._rawPrevTime === u) &&
                    f._rawPrevTime !== t &&
                    f._first &&
                    ((a = !0), f._rawPrevTime > u && (o = 'onReverseComplete'))),
                (f._rawPrevTime = f._duration || !e || t || f._rawPrevTime === t ? t : u),
                (t = d + 1e-4);
            else if (t < u)
              if (
                ...
                if (((f._rawPrevTime = f._duration || !e || t || f._rawPrevTime === t ? t : u), 0 === t && n))
              ...
              if (f._hasPause && !f._forcingPlayhead && !e) {
                if (_ <= t)
                  ...
                  for (r = f._last; r && r._startTime >= t && !l; )
                    r._duration || ('isPause' === r.data && 0 < r._rawPrevTime && (l = r)), (r = r._prev);
                l && ((f._time = f._totalTime = t = l._startTime), (p = f._startTime + t / f._timeScale));
              }
            ...
            if ((f._time !== _ && f._first) || i || a || l) {
              if (
                ...
                f._active || (!f._paused && f._time !== _ && 0 < t && (f._active = !0)),
                0 === _ && f.vars.onStart && ((0 === f._time && f._duration) || e || f._callback('onStart')),
                _ <= (h = f._time))
              )
                for (r = f._first; r && ((s = r._next), h === f._time && (!f._paused || y)); )
                ...
                for (r = f._last; r && ((s = r._prev), h === f._time && (!f._paused || y)); ) {
                  if (r._active || (r._startTime <= _ && !r._paused && !r._gc)) {
                    if (l === r) {
                      for (l = r._prev; l && l.endTime() > f._time; )
                        l.render(
                          l._reversed
                            ? l.totalDuration() - (t - l._startTime) * l._timeScale
              ...
              f._onUpdate && (e || (c.length && D(), f._callback('onUpdate'))),
                o &&
                  (f._gc ||
                    ...
                    (n && (c.length && D(), f._timeline.autoRemoveChildren && f._enabled(!1, !1), (f._active = !1)),
          ...
          (m.getChildren = function (t, e, r, n) {
            ...
            for (var s = [], o = this._first, a = 0; o; )
              o._startTime < n ||
                (o instanceof i
                  ? !1 !== e && (s[a++] = o)
                  : (!1 !== r && (s[a++] = o), !1 !== t && (a = (s = s.concat(o.getChildren(!0, e, r))).length))),
                (o = o._next);
            return s;
          }),
          (m.getTweensOf = function (t, e) {
            var r,
              ...
              o = [],
              a = 0;
            for (s && this._enabled(!0, !0), n = (r = i.getTweensOf(t)).length; -1 < --n; )
          ...
          (m._kill = function (t, e) {
            ...
            for (var i = e ? this.getTweensOf(e) : this.getChildren(!0, !0, !1), r = i.length, n = !1; -1 < --r; )
              i[r]._kill(t, e) && (n = !0);
            return n;
          }),
          (m.clear = function (t) {
          ...
          (m.totalDuration = function (t) {
            ...
            if (this._dirty) {
              for (var e, i, r = 0, n = this, s = n._last, o = 999999999999; s; )
                (e = s._prev),
                  s._dirty && s.totalDuration(),
                  s._startTime > o && n._sortChildren && !s._paused && !n._calculatingDuration
                    ? ((n._calculatingDuration = 1), n.add(s, s._startTime - s._delay), (n._calculatingDuration = 0))
                    : (o = s._startTime),
                  s._startTime < 0 &&
                    !s._paused &&
                    ((r -= s._startTime),
                    ...
                    (o = 0)),
                  r < (i = s._startTime + s._totalDuration / s._timeScale) && (r = i),
                  (s = e);
            ...
            function (e) {
              for (
                ...
                (i = D ? Math.random() : (1 / f) * c),
                  ...
                  D ? (n += Math.random() * s - 0.5 * s) : c % 2 ? (n += 0.5 * s) : (n -= 0.5 * s),
                  _ && (1 < n ? (n = 1) : n < 0 && (n = 0)),
                  (h[p++] = { x: i, y: n });
              for (
                h.sort(function (t, e) {
              ...
              var n = c(
                  ...
                  function (t, e) {
                    (this._p1 = 1 <= t ? t : 1),
                      ...
                      (this._p3 = (this._p2 / p) * (Math.asin(1 / this._p1) || 0)),
                      (this._p2 = p / this._p2);
                  },
                  !0,
                ),
  ...
  (
    ...
    function e(t, e) {
      ...
      return (
        t === s &&
          (null != t.pageXOffset ? (i = 'page' + e.toUpperCase() + 'Offset') : (t = null != n[i] ? n : document.body)),
        function () {
          return t[i];
        }
      );
    ...
    function i(t, i) {
      var r = (function (t) {
          return (
            ...
            t.length && t !== s && t[0] && t[0].style && !t.nodeType && (t = t[0]),
      ...
      o = _gsScope._gsDefine.plugin({
        ...
        init: function (t, i, n) {
          return (
            ...
            (this._tween = n),
            'object' != typeof i
              ? 'string' == typeof (i = { y: i }).y && 'max' !== i.y && '=' !== i.y.charAt(1) && (i.x = i.y)
            ...
            null != i.x
              ? (this._addTween(this, 'x', this.x, r(i.x, t, 'x', this.x) - (i.offsetX || 0), 'scrollTo_x', !0),
                this._overwriteProps.push('scrollTo_x'))
              : (this.skipX = !0),
            null != i.y
              ? (this._addTween(this, 'y', this.y, r(i.y, t, 'y', this.y) - (i.offsetY || 0), 'scrollTo_y', !0),
        ...
        set: function (e) {
          ...
          this.x < 0 && (this.x = 0),
            this.y < 0 && (this.y = 0),
            this._autoKill &&
              (!this.skipX && (u < a || a < -u) && i < t(this._target, 'x') && (this.skipX = !0),
              !this.skipY && (u < n || n < -u) && r < t(this._target, 'y') && (this.skipY = !0),
              this.skipX &&
                this.skipY &&
                (this._tween.kill(),
  ...
  (function (t, e) {
    ...
    function s(t, e) {
      for (var i, r = e.length; -1 < --r; ) if (((i = e[r]), t.substr(0, i.length) === i)) return i.length;
    }
    function o(t, e) {
      void 0 === t && (t = '');
      var i = ~t.indexOf('++'),
    ...
    function a(t, e, i) {
      var r = t.nodeType;
      if (1 === r || 9 === r || 11 === r) for (t = t.firstChild; t; t = t.nextSibling) a(t, e, i);
    ...
    function f(t, e, r, s, o, f, c) {
      var _,
        ...
        H = ~(q || '').indexOf('++'),
        G = [];
      for (H && (q = q.split('++').join('')), m = (d = t.getElementsByTagName('*')).length, y = [], _ = 0; _ < m; _++)
        y[_] = d[_];
      if (j || U)
        for (_ = 0; _ < m; _++)
          ((v = (g = y[_]).parentNode === t) || U || (W && !V)) &&
            ((b = g.offsetTop),
            j && v && Math.abs(b - O) > B && ('BR' !== g.nodeName || 0 === _) && ((x = []), j.push(x), (O = b)),
            U && ((g._x = g.offsetLeft), (g._y = b), (g._w = g.offsetWidth), (g._h = g.offsetHeight)),
            j &&
              (((g._isSplit && v) ||
                (!W && v) ||
                (V && v) ||
                (!V && g.parentNode.parentNode === t && !g.parentNode._isSplit)) &&
                (x.push(g), (g._x -= P), l(g, t, X) && (g._wordEnd = !0)),
              'BR' === g.nodeName && ((g.nextSibling && 'BR' === g.nextSibling.nodeName) || 0 === _) && j.push([])));
      for (_ = 0; _ < m; _++)
        (v = (g = y[_]).parentNode === t),
          'BR' !== g.nodeName
            ? (U &&
                ((F = g.style),
                V || v || ((g._x += g.parentNode._x), (g._y += g.parentNode._y)),
                (F.left = g._x + 'px'),
                (F.top = g._y + 'px'),
                (F.position = 'absolute'),
                (F.display = 'block'),
              ...
              !V && W
                ...
                ? N.push(g)
                : W && !g._isSplit && ('span' === z && (g.style.display = 'inline'), I.push(g)))
            : j || U
            ? (g.parentNode && g.parentNode.removeChild(g), y.splice(_--, 1), m--)
            : V || t.appendChild(g);
          ...
          for (
            x = j[_],
              (T = D.createElement(z)).style.cssText =
                'display:block;text-align:' + M + ';position:' + (U ? 'absolute;' : 'relative;'),
            ...
            'BR' !== x[d].nodeName &&
              ...
              U &&
                (0 === d && ((T.style.top = g._y + 'px'), (T.style.left = P + b + 'px')),
                (g.style.top = '0px'),
                b && (g.style.left = g._x - b + 'px')));
          0 === m ? (T.innerHTML = '&nbsp;') : V || W || (h(T), a(T, String.fromCharCode(160), ' ')),
      ...
      U &&
        (c > t.clientHeight && ((t.style.height = c - k + 'px'), t.clientHeight < c && (t.style.height = c + S + 'px')),
        f > t.clientWidth && ((t.style.width = f - R + 'px'), t.clientWidth < f && (t.style.width = f + A + 'px'))),
        u(r, I),
        V && u(s, N),
        u(o, L);
    }
    function c(t, o, u, l) {
      ...
      !(function (t, i, r, o) {
        var u,
          ...
          T = '</' + m + '>',
          w = 1,
          b = i.specialChars ? ('function' == typeof i.specialChars ? i.specialChars : s) : null,
        ...
        for (
          ...
          if (((c = u.charAt(h)), b && (d = b(u.substr(h), i.specialChars))))
            (c = u.substr(h, d || 1)), (l += v && ' ' !== c ? o() + c + '</' + m + '>' : c), (h += d - 1);
          else if (c === C && u.charAt(h - 1) !== C && h) {
            for (l += w ? T : '', w = 0; u.charAt(h + 1) === C; ) (l += F), h++;
            h === f - 1 ? (l += F) : ')' !== u.charAt(h + 1) && ((l += F + r()), (w = 1));
          } else
            '{' === c && '{{LT}}' === u.substr(h, 6)
              ? ((l += v ? o() + '{{LT}}</' + m + '>' : '{{LT}}'), (h += 5))
              ...
              ? ((p = ((u.substr(h, 12).split(e) || [])[1] || '').length || 2),
                (l += v && ' ' !== c ? o() + u.substr(h, p) + '</' + m + '>' : u.substr(h, p)),
                (h += p - 1))
              : (l += v && ' ' !== c ? o() + c + '</' + m + '>' : c);
    ...
    (C.version = '3.0.0'), (t.SplitText = C), (t.default = C), Object.defineProperty(t, '__esModule', { value: !0 });
  }),
  (
    (_gsScope =
      'undefined' != typeof module && module.exports && 'undefined' != typeof global ? global : this || window)
      ...
      function (t, e) {
        ...
        function d(t, e) {
          ...
          if ((e = e || _(t)))
            if ((i = e.length))
              for (; -1 < --i; )
                (-1 !== (n = e[i]).indexOf('-transform') && Xt !== n) || (s[n.replace(W, h)] = e.getPropertyValue(n));
            else for (i in e) (-1 !== i.indexOf('Transform') && Lt !== i) || (s[i] = e[i]);
          else if ((e = t.currentStyle || t.style))
            for (i in e) 'string' == typeof i && void 0 === s[i] && (s[i.replace(W, h)] = e[i]);
          return (
            ot || (s.opacity = f(t)),
            (r = Zt(t, e, !1)),
            ...
            (s.x = r.x),
            (s.y = r.y),
            Yt && ((s.z = r.z), (s.rotationX = r.rotationX), (s.rotationY = r.rotationY), (s.scaleZ = r.scaleZ)),
        ...
        function m(t, e, i, r, n) {
          ...
          for (o in i)
            'cssText' !== o &&
              ...
              ((u[o] =
                'auto' !== s || ('left' !== o && 'top' !== o)
                  ? ('' !== s && 'auto' !== s && 'none' !== s) || 'string' != typeof e[o] || '' === e[o].replace(N, '')
                    ? s
                    : 0
                  : ft(t, o)),
        ...
        function g(t, e, i) {
          if ('svg' === (t.nodeName + '').toLowerCase()) return (i || _(t))[e] || 0;
                ...
                : ((n = 360),
                  ...
                  s.length &&
                    ...
                    -1 !== t.indexOf('_cw') && o < 0
                      ...
                      : -1 !== t.indexOf('ccw') && 0 < o && (o = ((o - 3599999999640) % n) - ((o / n) | 0) * n)),
                  e + o)) < 1e-6 &&
              -1e-6 < a &&
              (a = 0),
            a
        ...
        var T,
          ...
          ot =
            ...
            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(st) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(st)) &&
              (O = parseFloat(RegExp.$1)),
            !!R && ((R.style.cssText = 'top:1px;opacity:.55;'), /^0.55/.test(R.style.opacity))),
          at = '',
          ut = '',
          lt = 'undefined' != typeof window ? window : et.defaultView || { getComputedStyle: function () {} },
          ht = (o.getStyle = function (t, e, i, r, n) {
            ...
            return ot || 'opacity' !== e
              ? (!r && t.style[e]
                  ? (s = t.style[e])
                  : (i = i || _(t))
                  ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(V, '-$1').toLowerCase()))
          ...
          pt = (nt.convertToPixels = function (t, i, r, n, s) {
            ...
            if ((c && (r = -r), D && (r *= 100), 'lineHeight' !== i || n))
              if ('%' === n && -1 !== i.indexOf('border')) a = (r / 100) * (h ? t.clientWidth : t.clientHeight);
              else {
                if (
                  ((f.cssText = 'border:0 solid red;position:' + ht(t, 'position') + ';line-height:0;'),
                  ...
                  if (
                    ...
                    -1 !== ht(p, 'display').indexOf('flex') && (f.position = 'absolute'),
                    (u = p._gsCache),
                    (l = e.ticker.frame),
                    u && h && u.time === l)
                  )
                ...
                p.appendChild(it),
                  ...
                  h &&
                    '%' === n &&
                    !1 !== o.cacheWidths &&
                    (((u = p._gsCache = p._gsCache || {}).time = l), (u.width = (a / r) * 100)),
                ...
                if ((',' === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), dt[t])) i = dt[t];
                  ...
                  if (((i = f = t.match(B)), e)) {
                    ...
                    (o = (Number(i[0]) % 360) / 360),
                      (a = Number(i[1]) / 100),
                      (r = 2 * (u = Number(i[2]) / 100) - (n = u <= 0.5 ? u * (a + 1) : u + a - u * a)),
              ...
              e &&
                ...
                l === h
                  ...
                  : ((p = l - h),
                    ...
                    (o = l === r ? (n - s) / p + (n < s ? 6 : 0) : l === n ? (s - r) / p + 2 : (r - n) / p + 4),
                    (o *= 60)),
                (i[0] = (o + 0.5) | 0),
                (i[1] = (100 * a + 0.5) | 0),
                (i[2] = (100 * u + 0.5) | 0)),
            ...
            ? (n = e
                ? function (t) {
                    ...
                    if ('number' == typeof t) t += p;
                      ...
                      for (D = t.replace(Q, '|').split('|'), c = 0; c < D.length; c++) D[c] = n(D[c]);
                      return D.join(',');
                    }
                    if (((e = (t.match(gt) || [s])[0]), (c = (f = t.split(e).join('').match(I) || []).length), h > c--))
                ...
                : function (t) {
                    ...
                    if ('number' == typeof t) t += p;
                      ...
                      for (s = t.replace(Q, '|').split('|'), f = 0; f < s.length; f++) s[f] = n(s[f]);
                      return s.join(',');
                    }
        ...
        (gt = new RegExp(gt + ')', 'gi')),
          (o.colorStringFilter = function (t) {
            var e,
              i = t[0] + ' ' + t[1];
            gt.test(i) &&
              ((e = -1 !== i.indexOf('hsl(') || -1 !== i.indexOf('hsla(')), (t[0] = F(t[0], e)), (t[1] = F(t[1], e))),
              (gt.lastIndex = 0);
          }),
        ...
        var Ct =
            ((nt._setPluginRatio = function (t) {
              ...
              for (var e, i, r, n, s, o = this.data, a = o.proxy, u = o.firstMPT; u; )
                (e = a[u.v]), u.r ? (e = u.r(e)) : e < 1e-6 && -1e-6 < e && (e = 0), (u.t[u.p] = e), (u = u._next);
              if (
                (o.autoRotate &&
            ...
            ((nt._parseToProxy = function (t, e, i, r, n, s) {
              ...
              for (
                i._transform = null,
                  ...
                  r = h = i.parse(t, e, r, n),
                  J = _,
                  s && ((i._transform = D), p && ((p._prev = null), p._prev && (p._prev._next = null)));
                r && r !== p;
          ...
          Tt = (o.parseComplex = function (t, e, i, r, n, s, a, u, l, h) {
            ...
            for (
              (-1 === r.indexOf(',') && -1 === i.indexOf(',')) ||
                ((E =
                  -1 !== (r + i).indexOf('rgb') || -1 !== (r + i).indexOf('hsl')
                    ? ((b = b.join(' ').replace(Q, ', ').split(' ')), E.join(' ').replace(Q, ', ').split(' '))
              ...
              if (((D = b[p]), (_ = E[p] + ''), (g = parseFloat(D)) || 0 === g))
                a.appendXtra('', g, y(_, g), _.replace(M, ''), O && -1 !== _.indexOf('px') && Math.round, !0);
              else if (n && gt.test(D))
                  ...
                  (v = 6 < D.length + _.length) && !ot && 0 === _[3]
                    ...
                    : (ot || (v = !1),
                      w
                        ? a
                            .appendXtra(
                              x.substr(0, x.indexOf('hsl')) + (v ? 'hsla(' : 'hsl('),
                              D[0],
                              y(_[0], D[0]),
                              ',',
                              !1,
                            ...
                            .appendXtra('', D[2], y(_[2], D[2]), v ? '%,' : '%' + F, !1)
                        : a
                            .appendXtra(
                              x.substr(0, x.indexOf('rgb')) + (v ? 'rgba(' : 'rgb('),
                              D[0],
                              _[0] - D[0],
                              ',',
                              Math.round,
                            ...
                            .appendXtra('', D[2], _[2] - D[2], v ? ',' : F, Math.round),
                      v && ((D = D.length < 4 ? 1 : D[3]), a.appendXtra('', D, (_.length < 4 ? 1 : _[3]) - D, F, !1))),
                  (gt.lastIndex = 0);
              else if ((d = D.match(B))) {
            ...
            if (-1 !== r.indexOf('=') && a.data) {
              for (F = a.xs0 + a.data.s, p = 1; p < a.l; p++) F += a['xs' + p] + a.data['xn' + p];
              a.e = F + a['xs' + p];
            }
            return a.l || ((a.type = -1), (a.xs0 = a.e)), a.xfirst || a;
          }),
          wt = 9;
        for ((l = Ft.prototype).l = l.pr = 0; 0 < --wt; ) (l['xn' + wt] = 0), (l['xs' + wt] = '');
        function bt(t, e) {
          (e = e || {}),
                ...
                ? (o.l++,
                  ...
                  0 < a
                    ? ((o.data['xn' + a] = e + i),
                      ...
                      (o['xn' + a] = e),
                      o.plugin ||
                        ((o.xfirst = new Ft(o, 'xn' + a, e, i, o.xfirst || o, 0, o.n, n, o.pr)), (o.xfirst.xs0 = 0)))
                    : ((o.data = { s: e + i }), (o.rxp = {}), (o.s = e), (o.c = i), (o.r = n)))
                : (o['xs' + a] += e + (r || '')),
              o
            );
          });
          ...
          if (f) {
            ...
            if (
              (null != r.ox &&
                ...
                (v += D - (c * l + D * h))),
              (g += m
                ? ', Dx=' + ((c = _ / 2) - (c * a + (D = d / 2) * u) + y) + ', Dy=' + (D - (c * l + D * h) + v) + ')'
              ...
              for (
                c = r.ieOffsetX || 0,
                  D = r.ieOffsetY || 0,
                  r.ieOffsetX = Math.round((_ - ((a < 0 ? -a : a) * _ + (u < 0 ? -u : u) * d)) / 2 + y),
                  r.ieOffsetY = Math.round((d - ((h < 0 ? -h : h) * d + (l < 0 ? -l : l) * _)) / 2 + v),
                  wt = 0;
                wt < 4;
                wt++
              )
                (F =
                  (i =
                    -1 !== (x = f[(C = Dt[wt])]).indexOf('px')
                      ? parseFloat(x)
                      : pt(this.t, C, parseFloat(x), x.replace(L, '')) || 0) !== r[C]
                    ? wt < 2
                      ? -r.ieOffsetX
                      : -r.ieOffsetY
                    : wt < 2
                    ? c - r.ieOffsetX
                    : D - r.ieOffsetY),
                  (p[C] = (r[C] = Math.round(i - F * (0 === wt || 2 === wt ? 1 : T))) + 'px');
            }
          }
        }
        ((l = bt.prototype).parseComplex = function (t, e, i, r, n, s) {
          ...
          if (
            (this.multi &&
              (Q.test(i) || Q.test(e)
                ? ((a = e.replace(Q, '|').split('|')), (u = i.replace(Q, '|').split('|')))
                : f && ((a = [e]), (u = [i]))),
            u)
          ) {
            for (l = u.length > a.length ? u.length : a.length, o = 0; o < l; o++)
              (e = a[o] = a[o] || this.dflt),
                (i = u[o] = u[o] || this.dflt),
                f &&
                  (h = e.indexOf(f)) !== (p = i.indexOf(f)) &&
                  (-1 === p ? (a[o] = a[o].split(f).join('')) : -1 === h && (a[o] += ' ' + f));
            (e = a.join(', ')), (i = u.join(', '));
          }
          return Tt(t, this.p, e, i, this.clrs, this.dflt, r, this.pr, n, s);
        }),
          (l.parse = function (t, e, i, r, s, o, a) {
            return this.parseComplex(t.style, this.format(ht(t, this.p, n, !1, this.dflt)), this.format(e), s, o);
          }),
        ...
        var kt,
          ...
          jt = (nt.Transform = function () {
            (this.perspective = parseFloat(o.defaultTransformPerspective) || 0),
              (this.force3D = !(!1 === o.defaultForce3D || !Yt) && (o.defaultForce3D || 'auto'));
          }),
          ...
          Ut =
            ...
            et.createElementNS &&
              !It &&
              ((Rt = Ot('svg', Wt)),
              (Mt = (Bt = Ot('rect', Rt, { width: 100, height: 50, x: 100 })).getBoundingClientRect().width),
              (Bt.style[zt] = '50% 50%'),
          ...
          qt = function (t) {
            ...
            if ((Wt.appendChild(i), i.appendChild(this), (this.style.display = 'block'), t))
              try {
          ...
          Qt = function (t, e) {
            ...
            if (
              ...
              Lt &&
                ...
                ((s = h.display),
                (h.display = 'block'),
                ((u = t.parentNode) && t.offsetParent) || ((o = 1), (a = t.nextSibling), Wt.appendChild(t)),
                (i = !(r = ht(t, Xt, null, !0)) || 'none' === r || 'matrix(1, 0, 0, 1, 0, 0)' === r),
                s ? (h.display = s) : te(h, 'display'),
                o && (a ? u.insertBefore(t, a) : u ? u.appendChild(t) : Wt.removeChild(t))),
              (l.svg || (t.getCTM && Ht(t))) &&
                (i && -1 !== (h[Lt] + '').indexOf('matrix') && ((r = h[Lt]), (i = 0)),
            ...
            for (n = (r || '').match(B) || [], wt = n.length; -1 < --wt; )
              (s = Number(n[wt])), (n[wt] = (o = s - (s |= 0)) ? ((1e5 * o + (o < 0 ? -0.5 : 0.5)) | 0) / 1e5 + s : s);
          ...
          Zt = (nt.getTransform = function (t, i, r, n) {
            ...
            var s,
              ...
              c = f.scaleX < 0,
              D = (Yt && (parseFloat(ht(t, zt, i, !1, '0 0 0').split(' ')[2]) || f.zOrigin)) || 0,
              _ = parseFloat(o.defaultTransformPerspective) || 0;
            if (
              ((f.svg = !(!t.getCTM || !Ht(t))),
              f.svg &&
                (St(t, ht(t, zt, i, !1, '50% 50%') + '', f, t.getAttribute('data-svg-origin')),
              ...
              if (16 === s.length) {
                var d,
                  ...
                  M = s[11],
                  I = Math.atan2(E, A);
                f.zOrigin && ((k = O * (B = -f.zOrigin) - s[12]), (R = S * B - s[13]), (B = A * B + f.zOrigin - s[14])),
                  (f.rotationX = I * K),
                  I &&
                  ...
                  (I = Math.atan2(w, b)),
                  (f.scaleX = ((1e5 * Math.sqrt(x * x + C * C + F * F) + 0.5) | 0) / 1e5),
                  (f.scaleY = ((1e5 * Math.sqrt(b * b + E * E) + 0.5) | 0) / 1e5),
                  (f.scaleZ = ((1e5 * Math.sqrt(O * O + S * S + A * A) + 0.5) | 0) / 1e5),
                  (x /= f.scaleX),
                  (w /= f.scaleY),
                  (C /= f.scaleX),
                  (b /= f.scaleY),
                  2e-5 < Math.abs(I)
                    ? ((f.skewX = I * K), (w = 0), 'simple' !== f.skewType && (f.scaleY *= 1 / Math.cos(I)))
                    : (f.skewX = 0),
                ...
                (f.x = s[4] || 0),
                  ...
                  (f.rotation = h),
                  (f.skewX = p),
                  Yt && ((f.rotationX = f.rotationY = f.z = 0), (f.perspective = _), (f.scaleZ = 1)),
                  f.svg &&
                  ...
                  b || z || I
                    ? ((b *= $),
                      ...
                      C &&
                        ...
                        (r *= e = Math.sqrt(1 + e * e)),
                        (o *= e),
                        X && ((e = Math.tan(X * $)), (i *= e = Math.sqrt(1 + e * e)), (s *= e))),
                      I &&
                        ((R += T.xOrigin - (T.xOrigin * i + T.yOrigin * r) + T.xOffset),
                        (B += T.yOrigin - (T.xOrigin * s + T.yOrigin * o) + T.yOffset),
                        kt &&
                    ...
                    (b *= $),
                      ...
                      z &&
                        ...
                        'simple' === T.skewType &&
                          ...
                          (d *= e = Math.sqrt(1 + e * e)),
                          (m *= e),
                          T.skewY && ((e = Math.tan(X * $)), (i *= e = Math.sqrt(1 + e * e)), (s *= e)))),
                      (r = -m),
                      (o = d);
                  else {
                    if (!(O || P || 1 !== k || N || I))
                      return void (w[Lt] =
                        (T.xPercent || T.yPercent
                          ? 'translate(' + T.xPercent + '%,' + T.yPercent + '%) translate3d('
                          : 'translate3d(') +
                        R +
                        'px,' +
                        B +
                  ...
                  (h = 1),
                    ...
                    (y =
                      T.xPercent || T.yPercent
                        ...
                        : 'matrix3d('),
                    (y += (i < _ && -_ < i ? x : i) + v + (s < _ && -_ < s ? x : s) + v + (u < _ && -_ < u ? x : u)),
                    (y +=
                      v + (p < _ && -_ < p ? x : p) + v + (r < _ && -_ < r ? x : r) + v + (o < _ && -_ < o ? x : o)),
                    P || O || 1 !== k
                      ? ((y +=
                          v +
                          (l < _ && -_ < l ? x : l) +
        ...
        function Kt(t) {
          ...
          100 == n &&
            ...
            e ||
              ...
              -1 === r.indexOf('pacity')
                ? (0 == n && this.xn1) || (i.filter = r + ' alpha(opacity=' + n + ')')
        ...
        ((l = jt.prototype).x =
          ...
          Et(
            'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
            {
              parser: function (t, e, i, r, s, a, u) {
                ...
                var l = (r._lastParsedTransform = u).scale && 'function' == typeof u.scale ? u.scale : 0;
                l && (u.scale = l(A, t));
                var h,
                  p,
                  f,
                  ...
                  P = T.transform && ('function' == typeof T.transform ? T.transform(A, S) : T.transform);
                if (
                  ...
                  ((p = it.style)[Lt] = P),
                    (p.display = 'block'),
                    (p.position = 'absolute'),
                    -1 !== P.indexOf('%') && ((p.width = ht(t, 'width')), (p.height = ht(t, 'height'))),
                    et.body.appendChild(it),
                    (h = Zt(it, null, !1)),
                    'simple' === E.skewType && (h.scaleY *= Math.cos(h.skewX * $)),
                    E.svg &&
                      ((_ = E.xOrigin),
                      (d = E.yOrigin),
                      (h.x -= E.xOffset),
                      ...
                      (T.transformOrigin || T.svgOrigin) &&
                        ((P = {}),
                        St(t, _t(T.transformOrigin), P, T.svgOrigin, T.smoothOrigin, !0),
                        (_ = P.xOrigin),
                        (d = P.yOrigin),
                        (h.x -= P.xOffset - E.xOffset),
                        (h.y -= P.yOffset - E.yOffset)),
                      (_ || d) &&
                        ((m = Qt(it, !0)), (h.x -= _ - (_ * m[0] + d * m[2])), (h.y -= d - (_ * m[1] + d * m[3])))),
                    et.body.removeChild(it),
                    h.perspective || (h.perspective = E.perspective),
                    null != T.xPercent && (h.xPercent = v(T.xPercent, E.xPercent)),
                    null != T.yPercent && (h.yPercent = v(T.yPercent, E.yPercent));
                else if ('object' == typeof T) {
                  if (
                    ((h = {
                      scaleX: v(null != T.scaleX ? T.scaleX : T.scale, E.scaleX),
                      scaleY: v(null != T.scaleY ? T.scaleY : T.scale, E.scaleY),
                  ...
                  'string' == typeof T.x && -1 !== T.x.indexOf('%') && ((h.x = 0), (h.xPercent = v(T.x, E.xPercent))),
                    'string' == typeof T.y && -1 !== T.y.indexOf('%') && ((h.y = 0), (h.yPercent = v(T.y, E.yPercent))),
                    (h.rotation = x(
                      'rotation' in T ? T.rotation : 'shortRotation' in T ? T.shortRotation + '_short' : E.rotation,
                      E.rotation,
                      'rotation',
                      w,
                    )),
                ...
                for (
                  Yt && null != T.force3D && ((E.force3D = T.force3D), (c = !0)),
                    (f =
                      E.force3D ||
                      E.z ||
                      E.rotationX ||
                  ...
                  (1e-6 < (P = h[(g = Nt[F])] - E[g]) || P < -1e-6 || null != T[g] || null != J[g]) &&
                    ((c = !0),
                ...
                return (
                  (P = 'function' == typeof T.transformOrigin ? T.transformOrigin(A, S) : T.transformOrigin),
                  E.svg &&
                    (P || T.svgOrigin) &&
                    ((_ = E.xOffset),
                    (d = E.yOffset),
                    St(t, _t(P), h, T.svgOrigin, T.smoothOrigin),
                    (s = xt(E, 'xOrigin', (y ? E : h).xOrigin, h.xOrigin, s, b)),
                    (s = xt(E, 'yOrigin', (y ? E : h).yOrigin, h.yOrigin, s, b)),
                    (_ === E.xOffset && d === E.yOffset) ||
                      ((s = xt(E, 'xOffset', y ? _ : E.xOffset, E.xOffset, s, b)),
                      (s = xt(E, 'yOffset', y ? d : E.yOffset, E.yOffset, s, b))),
                    (P = '0px 0px')),
                  (P || (Yt && f && E.zOrigin)) &&
                    (Lt
                      ? ((c = !0),
                        ...
                        Yt
                          ? ((p = E.zOrigin),
                            (P = P.split(' ')),
                            (E.zOrigin = (2 < P.length ? parseFloat(P[2]) : p) || 0),
                            (s.xs0 = s.e = P[0] + ' ' + (P[1] || '50%') + ' 0px'),
                            ((s = new Ft(E, 'zOrigin', 0, 0, s, -1, s.n)).b = p),
                            (s.xs0 = s.e = E.zOrigin))
                          : (s.xs0 = s.e = P))
                      : _t(P + '', E)),
                  c && (r._transformType = (E.svg && kt) || (!f && 3 !== this._transformType) ? 2 : 3),
                  l && (u.scale = l),
                  s
                );
              },
          ...
          Et('boxShadow', { defaultValue: '0px 0px 0px 0px #999', prefix: !0, color: !0, multi: !0, keyword: 'inset' }),
          Et('clipPath', {
          ...
          Et('borderRadius', {
            ...
            parser: function (t, e, i, s, o, a) {
              ...
              var u,
                ...
                b = t.style;
              for (
                m = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), u = e.split(' '), l = 0;
                l < w.length;
                l++
              )
                this.p.indexOf('border') && (w[l] = D(w[l])),
                  -1 !== (f = p = ht(t, w[l], n, !1, '0px')).indexOf(' ') && ((f = (p = f.split(' '))[0]), (p = p[1])),
                  (c = h = u[l]),
                  (_ = parseFloat(f)),
                  (v = f.substr((_ + '').length)),
                  '' ===
                    (y = (x = '=' === c.charAt(1))
                      ...
                      : ((d = parseFloat(c)), c.substr((d + '').length))) && (y = r[i] || v),
                  y !== v &&
                    ...
                    (p =
                      '%' === y
                        ? ((f = (C / m) * 100 + '%'), (F / g) * 100 + '%')
                        : 'em' === y
                        ? ((f = C / (T = pt(t, 'borderLeft', 1, 'em')) + 'em'), F / T + 'em')
                        : ((f = C + 'px'), F + 'px')),
                    x && ((c = parseFloat(f) + d + y), (h = parseFloat(p) + d + y))),
          ...
          Et('borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius', {
            ...
            parser: function (t, e, i, r, s, o) {
              return Tt(t.style, i, this.format(ht(t, i, n, !1, '0px 0px')), this.format(e), !1, '0px', s);
            },
            prefix: !0,
          ...
          Et('backgroundPosition', {
            ...
            parser: function (t, e, i, r, s, o) {
              ...
              if (
                ...
                for (a = d.split(' '), u = m.split(' '), rt.setAttribute('src', f), l = 2; -1 < --l; )
                  (h = -1 !== (d = a[l]).indexOf('%')) != (-1 !== u[l].indexOf('%')) &&
                    ((p = 0 === l ? t.offsetWidth - rt.width : t.offsetHeight - rt.height),
                    (a[l] = h ? (parseFloat(d) / 100) * p + 'px' : (parseFloat(d) / p) * 100 + '%'));
                d = a.join(' ');
              }
          ...
          Et('margin', { parser: vt('marginTop,marginRight,marginBottom,marginLeft') }),
          Et('padding', { parser: vt('paddingTop,paddingRight,paddingBottom,paddingLeft') }),
          Et('clip', {
              ...
              return (
                (e =
                  O < 9
                    ...
                    : ((a = this.format(ht(t, this.p, n, !1, this.dflt))), this.format(e))),
                this.parseComplex(t.style, a, e, s, o)
              );
            },
          }),
          Et('textShadow', { defaultValue: '0px 0px 0px #999', color: !0, multi: !0 }),
          ...
          Et('border', {
            ...
            parser: function (t, e, i, r, s, o) {
              var a = ht(t, 'borderTopWidth', n, !1, '0px'),
                ...
                l = u[0].replace(L, '');
              return (
                'px' !== l && (a = parseFloat(a) / pt(t, 'borderTopWidth', 1, l) + l),
                this.parseComplex(
                  t.style,
                  this.format(
                    a + ' ' + ht(t, 'borderTopStyle', n, !1, 'solid') + ' ' + ht(t, 'borderTopColor', n, !1, '#000'),
                  ),
                  u.join(' '),
                  s,
                  o,
          ...
          Et('borderWidth', { parser: vt('borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth') }),
          ...
          Et('opacity,alpha,autoAlpha', {
            ...
            parser: function (t, e, i, r, s, o) {
              ...
              return (
                ...
                l && 1 === a && 'hidden' === ht(t, 'visibility', n) && 0 !== e && (a = 0),
                ot
                  ? (s = new Ft(u, 'opacity', a, e - a, s))
                  : (((s = new Ft(u, 'opacity', 100 * a, 100 * (e - a), s)).xn1 = l ? 1 : 0),
                    (u.zoom = 1),
                    (s.type = 2),
          ...
          if (
            ...
            if ('all' === this.e) n = !(o.cssText = '');
              ...
              for (r = (e = this.e.split(' ').join('').split(',')).length; -1 < --r; )
                (i = e[r]),
                  u[i] && (u[i].parse === a ? (n = !0) : (i = 'transformOrigin' === i ? zt : u[i].p)),
                  te(o, i);
            n &&
              (te(o, Lt),
          ...
          Et('className', {
            parser: function (t, e, r, s, o, a, u) {
              var l,
                ...
                _ = t.style.cssText;
              if (
                (((o = s._classNamePT = new Ft(t, r, 0, 0, o, 2)).setRatio = Jt),
                (o.pr = -11),
                (i = !0),
                (o.b = D),
                (h = d(t, n)),
              ...
              return (
                ((t._gsClassPT = o).e =
                  '=' !== e.charAt(1)
                    ? e
                    : D.replace(new RegExp('(?:\\s|^)' + e.substr(2) + '(?![\\w-])'), '') +
        ...
        ((l = o.prototype)._firstPT = l._lastParsedTransform = l._transform = null),
          (l._onInitTween = function (t, e, a, l) {
            ...
            if (
              (w &&
                '' === C.zIndex &&
                (('auto' !== (h = ht(t, 'zIndex', n)) && '' !== h) || this._addLazySet(C, 'zIndex', 0)),
              'string' == typeof e &&
                ((c = C.cssText),
                (h = d(t, n)),
                (C.cssText = c + ';' + e),
                ...
                (C.cssText = c)),
              e.className
                ? (this._firstPT = p = u.className.parse(t, e.className, 'className', this, null, null, e))
                ...
                x = 3 === this._transformType,
                  Lt
                    ? b &&
                      ((w = !0),
                      '' === C.zIndex &&
                        (('auto' !== (y = ht(t, 'zIndex', n)) && '' !== y) || this._addLazySet(C, 'zIndex', 0)),
                      P &&
                        this._addLazySet(
                          C,
          ...
          (l.parse = function (t, e, i, s) {
            var o,
              ...
              v = t.style;
            for (o in e) {
              if (((f = e[o]), (a = u[o]), 'function' != typeof f || (a && a.allowFunc) || (f = f(A, S)), a))
                ...
                (p = ht(t, o, n) + ''),
                  (m = 'string' == typeof f),
                  'color' === o || 'fill' === o || 'stroke' === o || -1 !== o.indexOf('Color') || (m && j.test(f))
                    ? (m || (f = (3 < (f = mt(f)).length ? 'rgba(' : 'rgb(') + f.join(',') + ')'),
                      (i = Tt(v, o, p, f, !0, 'transparent', i, 0, s)))
                    : m && Z.test(f)
                    ? (i = Tt(v, o, p, f, !0, null, i, 0, s))
                    : ((D = (l = parseFloat(p)) || 0 === l ? p.substr((l + '').length) : ''),
                      ('' !== p && 'auto' !== p) ||
                        (D =
                          'width' === o || 'height' === o
                            ? ((l = g(t, o, n)), 'px')
                      ...
                      '' ===
                        (d = (y = m && '=' === f.charAt(1))
                          ? ((h = parseInt(f.charAt(0) + '1', 10)),
                            ...
                            (h *= parseFloat(f)),
                            f.replace(L, ''))
                          : ((h = parseFloat(f)), m ? f.replace(L, '') : '')) && (d = o in r ? r[o] : D),
                      ...
                      D === d ||
                        ...
                        ((l = pt(t, o, l, D)),
                        '%' === d
                          ? ((l /= pt(t, o, 100, '%') / 100), !0 !== e.strictUnits && (p = l + '%'))
                      ...
                      y && (h += l),
                      (!l && 0 !== l) || (!h && 0 !== h)
                        ? void 0 !== v[o] && (f || (f + '' != 'NaN' && null != f))
                          ? ((i = new Ft(v, o, h || l || 0, 0, i, -1, o, !1, 0, p, f)).xs0 =
                              'none' !== f || ('display' !== o && -1 === o.indexOf('Style')) ? f : p)
          ...
          if (t.slice) for (n = t.length; -1 < --n; ) re(t[n], e, i);
            ...
            for (n = (r = t.childNodes).length; -1 < --n; )
              (o = (s = r[n]).type),
                ...
                (1 !== o && 9 !== o && 11 !== o) || !s.childNodes.length || re(s, e, i);
        };
        return (
